...
mySubmit.onclick = function(){
    ...
    if(result === 'north avenue to quezon avenue'){
        resultElement.textContent =  ('Your payment should be around ' + (basefare*0.50) + ' pesos');
        ...
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate))*0.50) + ' pesos');
    }
     else if(result === 'north avenue to santolan-annapolis'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*2))*0.50) + ' pesos');
    }
     else if(result === 'north avenue to ortigas'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*3)) *0.50) + ' pesos');
    }
    else if(result === 'north avenue to shaw boulevard'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*4))*0.50) + ' pesos');
    }
        else if(result === 'north avenue to boni'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*5))*0.50) + ' pesos');
    }
            else if(result === 'north avenue to guadalupe'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*6))*0.50) + ' pesos');
    }
            else if(result === 'north avenue to buendia'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*7))*0.50) + ' pesos');
    }
            else if(result === 'north avenue to ayala'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*8)) *0.50) + ' pesos');
    }
            else if(result === 'north avenue to magallanes'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*9))*0.50) + ' pesos');
    }
            else if(result === 'north avenue to taft avenue'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*10))*0.50) + ' pesos');
    }
