...
// ChatGPT used to double check computations (https://chatgpt.com/share/69afd12a-b708-8005-b8cf-df65841c1d07)
    ...
    if(result === 'north avenue to quezon avenue'){
        ...
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*2))*0.80) + ' pesos');
    }
     else if(result === 'north avenue to santolan-annapolis'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*4))*0.80) + ' pesos');
    }
     else if(result === 'north avenue to ortigas'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*6))*0.80) + ' pesos');
    }
    else if(result === 'north avenue to shaw boulevard'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*7))*0.80) + ' pesos');
    }
        else if(result === 'north avenue to boni'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*8))*0.80) + ' pesos');
    }
            else if(result === 'north avenue to guadalupe'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*9))*0.80) + ' pesos');
    }
            else if(result === 'north avenue to buendia'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*11))*0.80) + ' pesos');
    }
            else if(result === 'north avenue to ayala'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*12))*0.80) + ' pesos');
    }
            else if(result === 'north avenue to magallanes'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*13))*0.80) + ' pesos');
    }
            else if(result === 'north avenue to taft avenue'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*15))*0.80) + ' pesos');
    }
    ...
    // QUEZON AVENUE = SOURCE
        ...
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate))*0.80) + ' pesos');
    }
     else if(result === 'quezon avenue to santolan-annapolis'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*3))*0.80) + ' pesos');
    }
     else if(result === 'quezon avenue to ortigas'){
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*5))*0.80) + ' pesos');
    }
        ...
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*10))*0.80) + ' pesos');
    }
        ...
        resultElement.textContent = ('Your payment should be around ' + ((basefare + (perKMrate*14))*0.80) + ' pesos');
    }
